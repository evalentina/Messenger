...
// Manager object to read and write data
...
extension DatabaseManager {
    ...
    // Creates a new conversation with the target user's email and the first message sent
    public func createNewConversation(with otherUserEmail: String, name: String, firstMessage: Message, completion: @escaping (Bool) -> Void) {
        ...
        ref.observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            // Update the recipient's conversation record
            ...
            // Update the current user conversation record
    ...
    // Gets all messages for this conversation
